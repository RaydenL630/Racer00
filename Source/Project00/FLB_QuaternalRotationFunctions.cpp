...
#include "FLB_QuaternalRotationFunctions.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UFLB_QuaternalRotationFunctions::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UFLB_QuaternalRotationFunctions::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UFLB_QuaternalRotationFunctions::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UFLB_QuaternalRotationFunctions::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void UFLB_QuaternalRotationFunctions::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UFLB_QuaternalRotationFunctions::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UFLB_QuaternalRotationFunctions::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
